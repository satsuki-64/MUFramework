...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp2(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp11(int p0, int p1, out int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp12(string p0, int[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(MyLuaTestClass.LuaTest.CustomCall2))
			{
			    return new MyLuaTestClass.LuaTest.CustomCall2(__Gen_Delegate_Imp3);
			}
		    ...
		    if (type == typeof(MyLuaTestClass.LuaTest.CustomCall))
			{
			    return new MyLuaTestClass.LuaTest.CustomCall(__Gen_Delegate_Imp9);
			}
		    ...
		    if (type == typeof(MyLuaTestClass.LuaTest.CustomCall3_New))
			{
			    return new MyLuaTestClass.LuaTest.CustomCall3_New(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(MyLuaTestClass.LuaTest.CustomCall4))
			{
			    return new MyLuaTestClass.LuaTest.CustomCall4(__Gen_Delegate_Imp12);
			}
